...
our_email = 'Your_Email_Here'
our_label = 'Your_Label_Here'

# get the Gmail API service
service = gmail_authenticate()

#Getting the right label
label = getLabel(service,our_label)

#Getting all the messages with this label
result = search_messages(service,'label:{}'.format(our_label))
for msg in result:
